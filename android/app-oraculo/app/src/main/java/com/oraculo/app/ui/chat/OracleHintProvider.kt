...
object OracleHintProvider {
    ...
    private val hints = listOf(
        ...
        "Has venido cargado de preguntas que pesan más que tus pasos. ",
        "Suelta el equipaje, el fuego hablará por ti.",
        "El destino no es un lugar al que vas, es el eco de lo que ya has hecho.",
        "Pasa, escuchemos el eco.",
